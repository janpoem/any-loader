(function (global, factory) {
  ...
  (global.AnyLoader = factory(global.BluebirdPromise));
}(this, (function (BluebirdPromise) { 'use strict';

  BluebirdPromise = BluebirdPromise && BluebirdPromise.hasOwnProperty('default') ? BluebirdPromise['default'] : BluebirdPromise;
  ...
  function () {
    ...
    _createClass(Loader, [{
      ...
      value: function isPlainObject(value) {
        ...
        return !(_typeof(value) !== 'object' || value === null || isArray(value) || value instanceof Promise || value instanceof BluebirdPromise);
      }
      /**
...
//# sourceMappingURL=any-loader.without-bluebird.umd.js.map
